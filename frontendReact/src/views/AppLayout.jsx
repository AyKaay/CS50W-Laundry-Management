...
function AppLayout({ children }) {
    return (
        <div className="min-h-screen flex flex-col">
            {/* Header */}
            <header className=" bg-white border-gray-200 dark:bg-gray-900 border dark:border-gray-800 border-b-1">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between  p-4">
                    {/* Logo */}
                    <a href="/" className="flex items-center">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJkz3CuW56-XSdgj1E38Rfrvai_iMUdanXMdaA5GPFYNnS8VI2Sr5OZ22OgBvYJrqMIEg&usqp=CAU" className="h-8 rounded-full pr-4" alt="Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Laundry</span>
                    </a>
            ...
            {/* Centre content */}
            <div className="flex-1 flex flex-col sm:flex-row h-screen">
                {/* Main content */}
                ...
                {/* Sidebar */}
                <nav className="bg-blue-300 order-first z-40 w-64 transition-transform sm:translate-x-0">
                    <div className="h-full px-3 py-4 overflow-y-auto bg-gray-500 dark:bg-gray-800 ">
                      <ul className="space-y-2 font-medium">
                          ...
                          <li>
                              <a href="/bills" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <footer className=" w-full bg-white shadow dark:bg-gray-900 z-50">
                <hr className=" border-gray-200 sm:mx-auto dark:border-gray-700 my-2 mt-10" />
                <span className="block text-sm mb-4 text-gray-500 sm:text-center dark:text-gray-400">© 2024. All Engine Ahead Flank.</span>
            </footer>
        </div>
    )
}
